<div class="container mt-4">
	<div class="row d-flex mb-2">
		<div class="col-12 col-sm-12 col-md-8 col-lg-8 col-xl-8">
			<h3 style="color:#656565">Employee Attendance</h3>
		</div>
		<div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
			...
			<div class="form-row">
				...
				<div class="col-5">
					<button type="submit" class="btn btn-success" style="border-radius:0%;"><i class="fas fa-sort"></i> Filter Date</button>
				</div>
			</div>
			<?php echo form_close(); ?>
		</div>
			...
			<table class="table table-striped table-hover">
				...
				<tbody>
					...
					<tr>
						...
						<td><a href="<?php echo base_url(); ?>employee/attadd/<?php echo $data[0][$i]; ?>/<?php echo $year; ?>/<?php echo $month; ?>"><button class="btn btn-warning btn-sm" style="border-radius:0%;">Manage</button></a></td>
					</tr>
					<?php } ?>
				</tbody>
			</table>
