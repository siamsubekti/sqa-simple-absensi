<div class="container mt-4">
	<div class="row justify-content-start">
		<h4 class="pr-2" style="color:#656565"><?php echo $employee->name; ?>'s attendance for </h4>
		<?php echo form_open("employee/attendance/1"); ?>
			<div class="form-row">
				...
				<div class="col-6">
					...
					<a href="<?php echo base_url(); ?>employee/attendance" class="btn btn-dark" style="border-radius:0%;">Go Back</a>
				</div>
			</div>
		<?php echo form_close(); ?>
	</div>
